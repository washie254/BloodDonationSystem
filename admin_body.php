            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php
                  ...
                  $sql = "SELECT * FROM body WHERE status='PENDING APPROVAL'";
                  ...
                  {	
                      ...
                      echo '<tr>';;
                          ...
                          echo '<td>'.$row[4].'</td> '; //LOCATION

                          //MARK AN INCIDENT AS SOLVED
                          echo '
                          <td>
                            <a href="approveb.php?id=' . $row[0] . '"><button type="button" class="btn btn-success">APPROVE</button></a>
                            <a href="rejectb.php?id=' . $row[0] . '"><button type="button" class="btn btn-danger">REJECT</button></a> 
                          </td>';
                      echo '</tr>';
                  }
                ?>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php
                  ...
                  $sql = "SELECT * FROM body WHERE status='REJECTED'";
                  $result = mysqli_query($db, $sql);
                  while($row = mysqli_fetch_array($result, MYSQLI_NUM))
                  {	
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php
                  ...
                  $sql = "SELECT * FROM body WHERE status='APPROVED'";
                  $result = mysqli_query($db, $sql);
                  while($row = mysqli_fetch_array($result, MYSQLI_NUM))
                  {	
