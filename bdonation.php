				...
				<div class="container">
					<div class="row align-items-center justify-content-between">
						...
						<div class="col-lg-5 col-md-6 home-about-right">
							<h6>Donate Blood</h6>
							<h1 class="text-uppercase">Donate Blood</h1>
							<p>
								You can save a lie by donating your blood. this occurs in several ways. you can participate in ared cross blood directive
								which are events organised by the red cross team. you can view scheduled blood drive events <a href="blooddrives.php"> here </a>and where they are to happen. 
								also you can view requests from patients on the platform and offer to donate blood to them <a href="bdonate.php">here</a>
							</p>
				...
				<div class="container">
					<div class="row align-items-center justify-content-between">
						...
						<div class="col-lg-5 col-md-6 home-about-right">
							...
							<a href="brequest.php" class="primary-btn text-uppercase">Request A Donatio</a>
							<p></p>
						</div>
					</div>
				</div>	
