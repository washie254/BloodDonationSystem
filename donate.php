      ...
      <div class="container" style="padding: 6px 12px; border: 1px solid #ccc;">
		...
		<div class="col-lg-12"  >
			...
			<?php
				...
				$sql = "SELECT * FROM donationrequests WHERE id='$reqid'"; 
				...
				{	
					...
					$location = $row[8];   
					$donorcount = $row[11];
					$contactperson = $row[16]." Tel: ".$row[15];
					$facility = $row[13]."  Ward#  ". $row[14];  
					$status = $row[12];   
					
					echo '
						<div class="card">
							<div class="card-body">
								Blood type : <b> '.$bloodtype.'</b><br>
								Date Requested : <b> '.$datetime.'</b><br>
								Location : <b> '.$location.'</b><br>
								donor count : <b>'.$bloodtype.'</b><br>
								Contact Person : <b>'.$contactperson.'</b><br>
								Facility : <b> '.$facility.'</b><br>
								Status : <b> '.$status.'</b><br>
								Donors Count : <b> '.$donorcount.'</b><br>
							</div>
						</div>
					';
				}
			...
			<?php include('errors.php');?>
				<input name="donorcount" value="<?=$donorcount?>" style="opacity: 0.2;" readonly/>
				<input name="donorid" value="<?=$uid?>" style="opacity: 0.2;" readonly/>
				<input name="requestid" value="<?=$reqid?>" style="opacity: 0.2;" readonly/>
				<input name="requesterid" value="<?=$requesterid?>" style="opacity: 0.2;" readonly/>
				<div class="form-group">	
					<div class="col-xs-6">
						<label for="em_tImage"><h4>Add some brief remarks</h4></label>
						<textarea type="text" class="form-control" name="donoremarks" id="donorremarks" required></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-xs-12">
						<br>
						<button class="btn btn-lg btn-success" style="width:100%;" type="submit" name="pledgedonation"><i class="glyphicon glyphicon-ok-sign"></i> Pledge donation</button>
					</div>
				</div>
